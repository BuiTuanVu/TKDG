...
function success(content, type) {
	type === 0
		? Modal.success({
				content: `Bài viết "${content}" - được lưu thành công`
			})
		: Modal.success({
				content: `Bài viết "${content}" - được gửi thành công`
			});
}
const { TabPane } = Tabs;
...
class CreatePost extends Component {
	...
	render() {
		...
		const { id } = this.state;
		const recentItem = postsData.filter((item) => item.id === id)[0];
		...
		const optionsMostUsed = [
			{ label: 'Đời sống', value: '1' },
			{ label: 'Xã hội', value: '2' },
			{ label: 'Thời sự', value: '3' },
			{ label: 'Công nghệ', value: '4' },
			{ label: 'Thể thao', value: '5' },
			{ label: 'Thể thao quốc tế', value: '6' }
		];
							...
							>
								<Form layout="vertical">
									...
									<Form.Item label="Mô tả tóm tắt">
										<TextArea cols={2} placeholder="Nhập mô tả ngắn gọn của bài viết" />
									</Form.Item>
							...
							>
								<Form layout="vertical">
									<Form.Item label="Tạo bài viết">
										...
										>
											<Button icon="save" onClick={(e) => success(postsData[0].title, 0)}>
												Lưu bài viết
											</Button>
											<Button icon="eye" onClick={this.showModalPreview}>
												Xem trước
											</Button>
										</div>
										...
										<div style={{ marginTop: 15 }}>
											<Button type="primary" onClick={(e) => success(postsData[0].title, 1)}>
												Gửi bài viết
											</Button>
										</div>
									</Form.Item>
					...
					>
						...
						<div style={{ marginTop: 20, paddingBottom: 30 }}>
							...
							<Tag style={{ fontSize: 15, fontWeight: 500 }}>
								<span>
									<a href="https://github.com/ant-design/ant-design/issues/1862">Bóng đá Việt Nam</a>
								</span>
							</Tag>
							<Tag style={{ fontSize: 15, fontWeight: 500 }}>
								<span>
									<a href="https://github.com/ant-design/ant-design/issues/1862">Thể thao</a>
								</span>
							</Tag>
						</div>
						<div
						...
						>
							<Button
								...
								onClick={(e) => this.handleCancelPreview()}
							>
								Quay lại
							</Button>
							<Button
